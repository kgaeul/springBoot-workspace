...
public class ItemService {
	...
	public void addItem(Item item, MultipartFile photoFile) throws Exception {
		
		//상품명 저장될 파일명 경로 생성
		//이미지 파일 정보에 대해서 추출
		String originPhtoName = photoFile.getOriginalFilename();
		String photoName = "";
		...
		String saveFileName = "khShop_" + originPhtoName;
		...
		item.setImgPath("/uploadImg/" + photoName);
